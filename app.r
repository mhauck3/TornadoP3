...
shinyApp(
  ui = navbarPage(h1("You Spin me Round!"),
                  ...
                  tabPanel(h2("About"),
                           h3("You Spin Me Round is an application made by Pedro Borges, Megan Hauck, Shoaib Khan and Namaswi Chandarana.  It was completed for UIC's Spring 2018 CS 424, Visualization and Visual Analytics, and Professor Andy Johnson."),
                           h3("The application visualizes 62,000 tornadoes for the entire U.S. from 1950 to 2016, with about 2,500 tornadoes in Illinois alone. Several features allow users to navigate tornado data about size and loss."),
                           HTML("<br>"),
                           h3("Data Links:"),
