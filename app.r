                  ...
                  tabPanel(h2("Analysis"),
                           ...
                           mainPanel("Analysis Plots",
                                     ...
                                     fluidPage(width= 11,
                                               ...
                                               tags$div(class = "c1",conditionalPanel(condition = "input.showTables == true",dataTableOutput("c1table")),
                                               ...
                                               tags$div(class = "c2",conditionalPanel(condition = "input.showTables == true",dataTableOutput("c2table")),
                                               ...
                                               tags$div(class = "c3",conditionalPanel(condition = "input.showTables == true",dataTableOutput("c3table")),
                                               ...
                                               tags$div(class = "c5",conditionalPanel(condition = "input.showTables == true",dataTableOutput("c5table")),
                                               conditionalPanel(condition = "input.showGraphs == true",plotlyOutput(width ="100%","c5"))),
                                               tags$div(class = "c6",conditionalPanel(condition = "input.showTables == true",dataTableOutput("c6table")),
                                               ...
                                               tags$div(class = "c7",conditionalPanel(condition = "input.showGraphs == true",plotlyOutput(width ="100%","c7"))),
